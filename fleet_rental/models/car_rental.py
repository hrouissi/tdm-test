...
class CarRentalContract(models.Model):
    ...
    rent_start_date = fields.Datetime(string="Test Drive Start", required=True, default=str(date.today()),
                                  help="Start date of contract", track_visibility='onchange')
    rent_end_date = fields.Datetime(string="Test Drive End", required=True, help="End date of contract",
